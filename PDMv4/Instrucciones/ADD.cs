...
{
    class ADD : Instruccion1Arg
    {

        public ADD(params Argumento[] args) : base(args)
        {
        ...
        public override byte Codigo
        {
            get
            {
                return (byte)(64 + (argumento as ArgRegistro).NumeroRegistro);
            }
        }
        ...
        {
            return "ADD " + Main.ObtenerNombreRegistro((argumento as ArgRegistro).NumeroRegistro);
        }
